...
describe("NetworkCongestionIndicator", () => {
  it("renders low signal icon when level is low", () => {
    const { getByTestId } = renderWithProviders(
      <NetworkCongestionIndicator level="low" testID="network-congestion" />,
    );
  ...
  it("renders medium signal icon when level is medium", () => {
    const { getByTestId } = renderWithProviders(
      <NetworkCongestionIndicator level="medium" testID="network-congestion" />,
    );
  ...
  it("renders high signal icon when level is high", () => {
    const { getByTestId } = renderWithProviders(
      <NetworkCongestionIndicator level="high" testID="network-congestion" />,
    );
